...
-- hop
vim.keymap.set({"n", "x"}, "gw", "<cmd>HopWord<CR>", { desc = "Hop to Words" })
vim.keymap.set({"n", "x"}, "gl", "<cmd>HopLine<CR>", { desc = "Hop to Lines" })
vim.keymap.set({"n", "x"}, "gs", "<cmd>HopPattern<CR>", { desc = "Hop to Pattern" })
