...
-- hop
vim.keymap.set({"n", "x", "i"}, "gw", "<cmd>HopWord<CR>", { desc = "Hop to Words" })
vim.keymap.set({"n", "x", "i"}, "gl", "<cmd>HopLine<CR>", { desc = "Hop to Lines" })
vim.keymap.set({"n", "x", "i"}, "gs", "<cmd>HopPattern<CR>", { desc = "Hop to Pattern" })
